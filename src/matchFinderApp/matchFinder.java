...
import src.matchFinderApp.observer.smsObserver;
import src.matchFinderApp.subject.messageSubject;
import src.matchFinderApp.subject.subject;
...
public class matchFinder {
    ...
    public static void main(String[] args) {
        ...
        if (responseBody != null) {
            ...
            s.notifySubscribers(leaguesMatches);
    ...
    private static String fetchMatchesForToday() {
        ...
        try (HttpClient client = HttpClient.newHttpClient()) {
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://api-football-v1.p.rapidapi.com/v3/fixtures?date=" + "2023-12-04"))
